  ...
  return (
    <div className="app-shell fiorati-embedded-calculator">
      <aside className="side-ledger">
        <div className="brand-lockup"><div><p className="brand-eyebrow">Caderno operacional</p><h1>PROJETO <span>ULISSES: FIORATI</span></h1></div></div>
